    ...
    def validate_value(cls, v: Any, _info):
        ...
        if not isinstance(v, list):
            msg = (
                ...
                "- A Data object (Agentcore's internal data structure)\n"
            )
        ...
        for i, item in enumerate(v):
            if not isinstance(item, dict | Data):
                msg = (
                    ...
                    "- A Data object (Agentcore's internal data structure for passing data between components)\n"
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Agentcore system.

    This component is used to handle text inputs in the Agentcore system.
    ...
    def _validate_value(v: Any, info):
        ...
        # Allow None values - they represent unset/empty inputs
        if v is None:
            value = None

...
from agentcore.utils.image import create_image_content_dict
...
class Data(BaseModel):
    ...
    def validate_data(cls, values):
        ...
        if not isinstance(values["data"], dict):
            msg = (
                ...
                " This will raise an error in version agentcore==1.3.0."
            )
            logger.warning(msg)
    ...
    def filter_data(self, filter_str: str) -> Data:
        ...
        """
        from agentcore.template.utils import apply_json_filter

        return apply_json_filter(self.data, filter_str)

    def to_message(self) -> Message:
        from agentcore.schema.message import Message  # Local import to avoid circular import
    ...
    def to_dataframe(self) -> DataFrame:
        from agentcore.schema.dataframe import DataFrame  # Local import to avoid circular import

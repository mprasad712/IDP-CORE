...
// IDP-specific sidebar categories — all other categories are hidden for this product
export const SIDEBAR_CATEGORIES = [
  { display_name: "Input",          name: "idp_input",          icon: "FileUp" },
  { display_name: "Pre-Processing", name: "idp_preprocessing",  icon: "SlidersHorizontal" },
  { display_name: "OCR",            name: "idp_ocr",            icon: "ScanText" },
  { display_name: "Extraction",     name: "idp_extraction",     icon: "FileSearch" },
  { display_name: "Rules",          name: "idp_rules",          icon: "ListFilter" },
  { display_name: "Output",         name: "idp_output",         icon: "FileDown" },
  { display_name: "Classification", name: "idp_classification", icon: "FolderSearch" },
  { display_name: "Detection",      name: "idp_detection",      icon: "Eye" },
  { display_name: "Validation",     name: "idp_validation",     icon: "CheckSquare" },
  { display_name: "Models",         name: "models",             icon: "BrainCog" },
];

// ── Previous full category list (preserved for reference / rollback) ──────────
// export const SIDEBAR_CATEGORIES = [
//   { display_name: "Saved", name: "saved_components", icon: "GradientSave" },
//   { display_name: "Input / Output", name: "input_output", icon: "Cable" },
//   { display_name: "Node", name: "agents", icon: "Bot" },
//   { display_name: "MCP", name: "mcp", icon: "Bot" },
//   { display_name: "Models Catalog", name: "models", icon: "BrainCog" },
//   ...(ENABLE_KNOWLEDGE_BASES ? [{ display_name: "Knowledge Bases", name: "knowledge_bases", icon: "Library" }] : []),
...
//   { display_name: "Language Models", name: "languagemodels", icon: "BrainCircuit" },
...
//   { display_name: "WolframAlpha", name: "wolframalpha", icon: "WolframAlphaAPI" },

...
import MCPAgentCore from "@/assets/MCPAgentCore.png";
  ...
  return (
    <div className="relative flex flex-col gap-3 rounded-xl border p-4 shadow-md">
      ...
      <div className="flex flex-col gap-3">
        ...
        <img src={MCPAgentCore} alt="MCP Notice Modal" className="rounded-xl" />
        <p className="text-sm text-secondary-foreground">
          Expose agents as tools from clients like Cursor or Claude.
        </p>
      </div>

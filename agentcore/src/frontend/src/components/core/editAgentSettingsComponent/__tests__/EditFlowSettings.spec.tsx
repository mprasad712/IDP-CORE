...
import EditAgentSettings from "../index";
...
describe("EditAgentSettings", () => {
  ...
  it("submits with Enter in description without Shift", () => {
    ...
    const desc = screen.getByTestId("input-agent-description");
  ...
  it("toggles lock switch", () => {
    ...
    const sw = screen.getByTestId("lock-agent-switch");
    fireEvent.click(sw);

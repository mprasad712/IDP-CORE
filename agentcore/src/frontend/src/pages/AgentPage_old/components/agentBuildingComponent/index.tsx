...
export default function AgentBuildingComponent() {
  ...
  const handleRetry = () => {
    if (pastBuildAgentParams) {
      buildAgent(pastBuildAgentParams);
    }
  };

    ...
    LLMExtractor: {
      ...
      template: {
        ...
        prompt: promptField(
          ...
          "Extraction Prompt",
          "",
          "Describe the fields to extract. Used when Extraction Mode is 'dynamic_prompt'.",
        ),
        config_name: strField(
          "config_name",
          "Field Configuration Name",
          "",
          "Name of the saved Field Configuration from the Configuration page. Used when Extraction Mode is 'field_configuration'.",
        ),
